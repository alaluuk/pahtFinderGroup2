...
exports.StructureType = require("./types/structure").StructureType;
exports.HouseStructureType = require("./types/house-structure").HouseStructureType;
exports.HouseType = require("./types/house").HouseType;